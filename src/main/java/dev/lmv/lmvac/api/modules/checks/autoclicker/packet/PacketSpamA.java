...
public class PacketSpamA extends Check implements PacketCheck, Configurable {
    public ConcurrentHashMap<UUID, List<DropData>> drops = new ConcurrentHashMap<>();
    public Long maxDiff = 1000L;
    public Integer maxTimes = 20;
