...
public class MovementUtil {
    ...
    public static Boolean checkMove(Player plr) {
        ...
        LmvPlayer targetPlayer = (LmvPlayer)LmvPlayer.players.get(id);
        return targetPlayer != null && ((plr.isSprinting() && !FluidUtil.isInFluid(plr) && !plr.isGliding() && !plr.isInsideVehicle()) || plr.isSneaking() || plr.isSleeping() || plr.isJumping() || plr.isDead());
    }
}
