...
public class CheckManager {
    ...
    public CheckManager(Plugin plugin) {
        ...
        checks = new ArrayList<>(Arrays.asList(
                ...
                new FlightC(plugin), new MetaCancel(plugin), new Snap360(plugin), new InventoryF(plugin),
                ...
                new InventoryG(plugin), new BadPacketsB(plugin), new AimPacketListener(LmvAC.instance), new AutoFishA(plugin), new PacketSpamA(plugin), new ClickSpamA(plugin)
        ));
